    ...
    >
      <header className={styles.header}>
        <div className={styles.headerCopy}>
          <p className={styles.eyebrow}>Pusat kendali program</p>
          <h1 className={styles.title} id={`${uid}-title`}>
            Pekerjaan
          </h1>
          <p className={styles.subtitle}>
            Lihat hasil yang sudah selesai, pekerjaan aktif, urutan berikutnya,
            dan hambatan dalam satu alur yang dapat ditindaklanjuti.
          </p>
        </div>
        <details className={styles.revisionDisclosure}>
          <summary>Versi data</summary>
      ...
      <section
        ...
        aria-labelledby={`${uid}-active-title`}
      >
        <div className={styles.activeBucketSummary}>
          <div>
            <p className={styles.summaryLabel}>Tampilan aktif</p>
            <h2 className={styles.summaryTitle} id={`${uid}-active-title`}>
              {activeBucketLabel}
            </h2>
          ...
          {typeof activeBucketCount === 'number' ? (
            ...
            >
              <strong>{activeBucketCount}</strong>
              <span>pekerjaan</span>
            </div>
          ) : null}
        </div>
        ...
        <div className={styles.filterBar} data-testid="work-filter-bar">
          <label className={styles.filterSearchLabel} htmlFor={`${uid}-query`}>
            <span className={styles.filterSearchCaption}>
              Cari di tampilan ini
            </span>
            <input
              id={`${uid}-query`}
              type="search"
          ...
          {pageStageChips.length > 0 ? (
            <details className={styles.stageDisclosure}>
              <summary>Tahap pada halaman ini</summary>
              <div
